...
# Arduino Uno (Center)
arduino_box = Rectangle((5.5, 12.8), 3, 1.3, facecolor=BLUE, 
                        edgecolor='black', linewidth=2, alpha=0.3)
ax.add_patch(arduino_box)
ax.text(7, 13.7, 'ARDUINO UNO', fontsize=13, fontweight='bold', ha='center')
ax.text(7, 13.3, 'ATmega328P\n5V | 16MHz', fontsize=9, ha='center')

# Temperature Sensor (Left)
temp_box = Rectangle((1.5, 12.8), 2.5, 1.3, facecolor=ORANGE,
                     edgecolor='black', linewidth=2, alpha=0.3)
ax.add_patch(temp_box)
ax.text(2.75, 13.6, 'TEMP SENSOR', fontsize=11, fontweight='bold', ha='center')
ax.text(2.75, 13.2, 'LM35/DS18B20\n±2°C accuracy\nPin: A0', fontsize=9, ha='center')

# Relay Module (Right)
relay_box = Rectangle((10, 12.8), 2.5, 1.3, facecolor=GREEN,
                      edgecolor='black', linewidth=2, alpha=0.3)
ax.add_patch(relay_box)
ax.text(11.25, 13.6, 'RELAY MODULE', fontsize=11, fontweight='bold', ha='center')
ax.text(11.25, 13.2, '5V Control\nPump Switching\nPin: 7', fontsize=9, ha='center')

# LED Indicators
led_green_box = Rectangle((1, 11.2), 2, 0.9, facecolor=LIGHT_GREEN,
                          edgecolor='black', linewidth=2)
ax.add_patch(led_green_box)
ax.text(2, 11.8, 'GREEN LED', fontsize=10, fontweight='bold', ha='center')
ax.text(2, 11.5, 'Stage 1\nPin: 2', fontsize=8, ha='center')

led_red_box = Rectangle((3.5, 11.2), 2, 0.9, facecolor=LIGHT_RED,
                        edgecolor='black', linewidth=2)
ax.add_patch(led_red_box)
ax.text(4.5, 11.8, 'RED LED', fontsize=10, fontweight='bold', ha='center')
ax.text(4.5, 11.5, 'Stage 2\nPin: 3', fontsize=8, ha='center')

# Water Pump
pump_box = Rectangle((6, 11.2), 2.5, 0.9, facecolor=LIGHT_BLUE,
                     edgecolor='black', linewidth=2)
ax.add_patch(pump_box)
ax.text(7.25, 11.8, 'WATER PUMP', fontsize=10, fontweight='bold', ha='center')
ax.text(7.25, 11.5, '2W | 25L/min', fontsize=8, ha='center')

# Power Supply
power_box = Rectangle((9, 11.2), 1.5, 0.9, facecolor='#ffff99',
                      edgecolor='black', linewidth=2)
ax.add_patch(power_box)
ax.text(9.75, 11.8, 'POWER', fontsize=10, fontweight='bold', ha='center')
ax.text(9.75, 11.5, '5V DC', fontsize=8, ha='center')
...
plt.tight_layout()
plt.savefig('/Users/assolabasova/Desktop/Hardware_1_System_Architecture.png', dpi=300, bbox_inches='tight', facecolor='white')
...
plt.tight_layout()
plt.savefig('/Users/assolabasova/Desktop/Hardware_2_Arduino_Flow.png', dpi=300, bbox_inches='tight', facecolor='white')
...
plt.tight_layout()
plt.savefig('/Users/assolabasova/Desktop/Hardware_3_Breadboard_Layout.png', dpi=300, bbox_inches='tight', facecolor='white')
